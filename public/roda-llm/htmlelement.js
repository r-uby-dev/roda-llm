...
.ac-status {
  ...
  /* The chevron after the heading, at the heading's own size. It takes the
     space after itself, so the heading and its mark sit together at the
     left and the close control stays at the right. */
  .ac-panel-caret {
    flex: none;
    font-size: 0.9em;
    margin-left: -0.35em;
...
<div class="ac-card ac-panel-view" part="card panel-view" popover="manual">
  <div class="ac-card-head ac-panel-head" part="card-head panel-head">
    ...
    <span class="ac-panel-caret" part="panel-caret" aria-hidden="true">&gt;</span>
