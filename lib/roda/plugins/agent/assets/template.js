/**
 * The console's shadow DOM: the markup the console drives,
 * and the styles that belong to it. Both are owned by the
 * plugin so a host application only has to render
 * `<agent-console>` and, optionally, slot in a placeholder,
 * tool labels and tool icons.
 */
const markup = `
<style>
  :host {
