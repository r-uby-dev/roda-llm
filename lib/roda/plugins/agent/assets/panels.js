 ...
 */
   ...
   */
    ...
    /* A newer pass has started since this one did, so this one is stale and
       leaves the body to it. */
  ...
  /* Bumped by every pass. A pass that is no longer the latest does not
     touch the body: the newest pass is the only one that should. */
  let generation = 0
